...
Export your Keystore file which you registered in. You can see how to get the Keystore file from this [documentation page](/operate-icon/how-to-create-a-wallet-account).
