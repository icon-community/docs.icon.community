...
<img src="/images/workflow-diagram.jpeg" alt="Workflow Diagram" width="1326" height="1473" />
...
| ROLE                 | 0                       | int  | true     | Role of running node.<ul><li>0: Citizen</li><li>3: P-Rep</li></ul>                  |
...
| CHECK\_STACK\_LIMIT  | 360                     | int  | false    | count- Restart container when stack value is reached                            |
