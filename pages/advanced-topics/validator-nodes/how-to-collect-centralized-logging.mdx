...
![](/images/logging-architecture.jpeg)
...
![](/images/before-after-fluentd.jpeg)
...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| LOG\_OUTPUT\_TYPE | <code>file</code> or <code>console</code> - Check the Firewall The following port open is required from the agent to the server. Udp port open is also required for syslog collection.        |
