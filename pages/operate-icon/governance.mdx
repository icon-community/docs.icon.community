...
The main blockchain-based network, as an extension of the [computational network structure](/operate-icon/network), contains community members with raised roles and responsibilities as voted upon by the community. These raised-role members are called [_delegates_](/operate-icon/governance/delegates), who are responsible for proposing changes for the purpose of improving network state given current context and future goals. These are referred to as [_network proposals_](/operate-icon/governance/network-proposals).
