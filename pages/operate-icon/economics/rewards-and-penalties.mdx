...
* Cross-chain message relay rewards are not currently set (May 26, 2022). This is a feature that is currently being developed and will be implemented in the future.
...
_The above variables may be changed by a_ [_Network Proposal_](/operate-icon/governance/network-proposals) _that has been successfully passed upon a vote by the_ [_Delegates_](/operate-icon/governance/delegates) _at the time of the vote._
