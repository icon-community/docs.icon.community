...
If you dont have the goloop CLI installed in your computer please follow [these instructions](/develop-on-icon-chain/blockchain-components/goloop/setup).

### Check if a Public Key exists

To verify if a PRep address has already registered a Public Key using the [goloop CLI](/develop-on-icon-chain/blockchain-components/goloop) you can use the following command:
...
To generate the Public Key using the [goloop CLI](../../concepts/computational-utilities/goloop) you can use the `goloop ks pubkey` [command](https://github.com/icon-project/goloop/blob/master/doc/goloop_cli.md#goloop-ks-pubkey) command as shown in the following example:
...
You can verify if your PRep node has already registered a Public Key by calling the [getPRep](https://github.com/icon-project/goloop/blob/master/doc/icon_chainscore_api.md#getprep) method of the chain contract.
...
You can also use the [icon-sdk-js](https://github.com/icon-project/icon-sdk-js) and call the `.getPublicKey(bool)` method of the [`IconWallet` object](https://github.com/icon-project/icon-sdk-js?tab=readme-ov-file#iconserviceiconwallet-wallet) to generate a Public key.
...
Instantiate a wallet object from the [IconWallet object class](https://github.com/icon-project/icon-sdk-js?tab=readme-ov-file#iconserviceiconwallet-wallet) using your private key and call the `.getPublicKey(true)` method to get your wallet private key.
