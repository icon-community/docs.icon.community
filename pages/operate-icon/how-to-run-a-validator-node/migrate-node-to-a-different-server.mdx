...
[How to create a wallet account](/operate-icon/how-to-create-a-wallet-account)
...
* [How to run a validator node](/operate-icon/how-to-run-a-validator-node)
...
- **Validator Block Check:** You can refer to this tutorial to check if a validator is missing blocks, which can be helpful during the migration process: [Validator Block Check Tutorial](/advanced-topics/validator-nodes/how-to-check-if-a-validator-is-missing-blocks).
...
- [How to Set Up a Keystore on a Validator Node](/advanced-topics/validator-nodes/how-to-setup-a-keystore-on-a-validator-node).

- [Node Operation and Configuration](/advanced-topics/validator-nodes/node-operation-and-configuration).
