...
[Setting up the project folder](/develop-on-icon-chain/accounts-and-authentication#setting-up-the-project-folder)

### Using goloop CLI

[Goloop CLI](/develop-on-icon-chain/blockchain-components/goloop) is a terminal utility that you can use to generate accounts and make RPC JSON requests easily from the command line.
