...
<div className='text-left px-4 sm:px-10 py-8 rounded bg-gradient-to-r from-light/0 via-light/0 to-light/0 dark:bg-gradient-to-r dark:from-search-dark dark:via-search-dark/60 dark:to-search-dark/20  mt-8'>
