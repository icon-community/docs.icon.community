...
For the case of showcasing sending a message without rollback please follow the prerequisites and instructions on the [previous tutorial](/cross-chain-communication/general-message-passing-xcall/quickstart/sending-a-message).
