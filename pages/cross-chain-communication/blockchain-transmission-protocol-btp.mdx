...
dApps interact with BTP through ICON's general message passing (xCall) contract. Testnet GMP contract addresses are listed below. For more information on ICON's general message passing (GMP), see [this dedicated section](/cross-chain-communication/general-message-passing-xcall) and [standard](https://github.com/icon-project/IIPs/blob/master/IIPS/iip-52.md)
