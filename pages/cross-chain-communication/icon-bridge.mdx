...
|-------------------|---------------------------------------------------|
| URI               | [https://lisbon.net.solidwallet.io/api/v3/icon_dex](https://lisbon.net.solidwallet.io/api/v3/icon_dex) |
| Network ID        | 0x2                                               |
...
| Network Parameter | Value                                             |
|-------------------|---------------------------------------------------|
| URI               | [https://ctz.solidwallet.io/api/v3/icon_dex](https://ctz.solidwallet.io/api/v3/icon_dex) |
| Network ID        | 0x1                                               |
