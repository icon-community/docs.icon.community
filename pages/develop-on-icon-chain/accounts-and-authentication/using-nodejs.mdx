...
For a more detailed explanation of how to serialize transaction data you can [visit the following tutorial](/operate-icon/how-to-use-the-json-rpc-api#how-to-serialize-transaction-data).
