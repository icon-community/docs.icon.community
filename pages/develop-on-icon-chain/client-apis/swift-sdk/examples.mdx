...
* [getLastBlock](examples.md#getlastblock)
* [getBlock(height)](examples.md#getblockheight)
* [getBlock(hash)](examples.md#getblockhash)
* [call](examples.md#call)
* [getBalance](examples.md#getbalance)
* [getScoreAPI](examples.md#getscoreapi)
* [getTotalSupply](examples.md#gettotalsupply)
* [getTransaction](examples.md#gettransaction)
* [getTransactionResult](examples.md#gettransactionresult)
...
* [API Reference](/develop-on-icon-chain/networks)
