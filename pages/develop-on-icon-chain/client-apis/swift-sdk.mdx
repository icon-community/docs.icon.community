...
`ICONService` is a class which provides APIs to communicate with ICON nodes. It enables you to easily use [ICON JSON-RPC APIs](https://github.com/icon-project/goloop/blob/master/doc/jsonrpc_v3.md) (version 3). All methods of `IconService` returns a `Request<T, ICError>` instance.
...
For more details of node URL and network id, see [ICON Network](/develop-on-icon-chain/networks) document.
...
| Parameter | Type     | Description                                                                                                                                       |
| --------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| nid       | `String` | A network ID. (Mainnet = "0x1", Testnet = "0x2", [etc](/icon-stack/icon-networks)) |
...
* **error(error: Error)**
* **message(error: String**) - [JSON RPC Error Messages](https://github.com/icon-project/goloop/blob/master/doc/jsonrpc_v3.md)
