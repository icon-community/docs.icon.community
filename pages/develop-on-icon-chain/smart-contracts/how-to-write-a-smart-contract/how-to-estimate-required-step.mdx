...
Below is a code snippet for Java. For the detailed ICON Java SDK usage guideline, please read [Java SDK ↗](https://github.com/icon-project/icon-sdk-java).
...
Step estimation code snippet for Python. For the detailed ICON Python SDK usage guideline, please read [Python SDK ↗](https://github.com/icon-project/icon-sdk-python).
