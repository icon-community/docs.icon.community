...
As a programmer, it is extremely important to understand of the security of your code. For developments on the ICON [Mainnet](/develop-on-icon-chain/networks), your code will be available for public use. This means that businesses and users will depend on your code to execute in the intended way. Some common concerns are described here.
