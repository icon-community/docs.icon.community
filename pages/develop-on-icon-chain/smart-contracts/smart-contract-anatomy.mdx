...
Permanent storage is much more expensive than temporary memory. See more information about the [ICON execution environments](/develop-on-icon-chain/icon-execution-environments) to understand exactly how data gets permanently stored, including information on the data structures and repercussions associated with them.
