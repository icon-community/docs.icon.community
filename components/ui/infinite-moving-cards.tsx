  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full shadow dark:shadow-0 relative rounded-full dark:border  flex-shrink-0 border-slate-700 px-8 py-2 md:w-fit bg-gradient-to-br dark:from-[#111111] dark:via-[#111111] dark:to-black from-white via-white to-gray-100"           
            key={idx}
          >
            <blockquote>
              <div
